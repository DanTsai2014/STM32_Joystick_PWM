...
void init_LED(void){
		...
		GPIO_InitStruct.GPIO_Pin =  GPIO_Pin_12 | GPIO_Pin_13| GPIO_Pin_14| GPIO_Pin_15; //PD12->LED3 PD13->LED4 PD14->LED5 PD15->LED6
...
//    init_USART6(9600);
    //USART1_Config();    // USART 6 for receiving Lidar message
        ...
        ret &= xTaskCreate(parse_Joystick_dir, "parse Joystick direction", 1024 /*configMINIMAL_STACK_SIZE*/,NULL, 4, NULL);
